...
public class MainController implements Initializable {
    ...
    @FXML private ComboBox<PresetRequest> presetComboBox;
    @FXML private TextArea requestBodyTextArea;
    @FXML private TextArea requestHeadersTextArea;
    ...
    private void setupMethodComboBox() {
        ...
        // Kompletan fix za prikaz teksta u method combo box-u
        methodComboBox.setButtonCell(new ListCell<String>() {
            ...
            protected void updateItem(String item, boolean empty) {
                ...
                setStyle("-fx-font-weight: 600; -fx-font-size: 14px;");
            }
        });
        
        methodComboBox.setCellFactory(new Callback<ListView<String>, ListCell<String>>() {
            @Override
    ...
    private void filterPresets(String method) {
        ...
        switch (method) {
            ...
            case "GET": filterGet.getStyleClass().add("active"); break;
            case "POST": filterPost.getStyleClass().add("active"); break;
            case "PUT": filterPut.getStyleClass().add("active"); break;
            case "DELETE": filterDelete.getStyleClass().add("active"); break;
        }
    ...
    private void sendRequest() {
        ...
        task.setOnSucceeded(e -> {
            ...
            Platform.runLater(() -> {
                ...
                responseBodyTextArea.setText(formatJsonString(response.getResponseBody()));
